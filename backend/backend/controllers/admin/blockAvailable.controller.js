  ...
  try {
    ...
    const newEntry = await BlockAvailable.create({
     ...
     airline_2: body.airline_2 ? body.airline_2 : "", 
      ...
      from_date_1: body.from_date_1 ? body.from_date_1 : "",
      from_date_2: body.from_date_2 ? body.from_date_2 : "",
      from_date_3: body.from_date_3 ? body.from_date_3 : "",
      from_date_4: body.from_date_4 ? body.from_date_4 : "",
